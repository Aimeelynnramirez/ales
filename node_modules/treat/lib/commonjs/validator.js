...
var fullStyleWithMedia = makeMediaQuerySchema(fullStyle);
var globalStyleWithMedia = makeMediaQuerySchema(fullStyle.forbiddenKeys.apply(fullStyle, ['selectors'].concat(transformCSS_1.simplePseudos)));
